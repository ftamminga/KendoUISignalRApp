...
//     Configuration file:     "KendoUISignalRApp\Web.config"
//     Connection String Name: "SampleDataContext"
//     Connection String:      "Server=eal-ftm-desktop;Database=Sample;Trusted_Connection=True;"
// ------------------------------------------------------------------------------------------------
...
namespace KendoUISignalRApp.Models
{
    ...
    public interface ISampleDataContext : System.IDisposable
    {
        ...
        System.Data.Entity.DbSet<Intraday> Intradays { get; set; } // Intraday
        System.Data.Entity.DbSet<Invoice> Invoices { get; set; } // Invoices
        System.Data.Entity.DbSet<Meeting> Meetings { get; set; } // Meetings
        System.Data.Entity.DbSet<MeetingAttendee> MeetingAttendees { get; set; } // MeetingAttendees
        ...
        System.Data.Entity.DbSet<Weather> Weathers { get; set; } // Weather
        ...
        int OrdersPaged(int? pagestart, int? pagesize, out int? numresults);
        // OrdersPagedAsync cannot be created due to having out parameters, or is relying on the procedure result (int)
    ...
    public class SampleDataContext : System.Data.Entity.DbContext, ISampleDataContext
    {
        ...
        public System.Data.Entity.DbSet<Intraday> Intradays { get; set; } // Intraday
        ...
        public System.Data.Entity.DbSet<MeetingAttendee> MeetingAttendees { get; set; } // MeetingAttendees
        ...
        public System.Data.Entity.DbSet<Weather> Weathers { get; set; } // Weather

        static SampleDataContext()
        {
            System.Data.Entity.Database.SetInitializer<SampleDataContext>(null);
        }
        ...
        public SampleDataContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model)
            : base(connectionString, model)
        {
        }

        public SampleDataContext(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
        }

        public SampleDataContext(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new IntradayConfiguration());
            ...
            modelBuilder.Configurations.Add(new WeatherConfiguration());
        }
        ...
        public static System.Data.Entity.DbModelBuilder CreateModel(System.Data.Entity.DbModelBuilder modelBuilder, string schema)
        {
            ...
            modelBuilder.Configurations.Add(new IntradayConfiguration(schema));
            ...
            modelBuilder.Configurations.Add(new WeatherConfiguration(schema));
            return modelBuilder;
        }
        ...
        public int OrdersPaged(int? pagestart, int? pagesize, out int? numresults)
        {
            var pagestartParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@pagestart", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Input, Value = pagestart.GetValueOrDefault(), Precision = 10, Scale = 0 };
            if (!pagestart.HasValue)
                pagestartParam.Value = System.DBNull.Value;
            ...
            var numresultsParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@numresults", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output, Precision = 10, Scale = 0 };
            var procResultParam = new System.Data.SqlClient.SqlParameter { ParameterName = "@procResult", SqlDbType = System.Data.SqlDbType.Int, Direction = System.Data.ParameterDirection.Output };
 
            Database.ExecuteSqlCommand("EXEC @procResult = [dbo].[Orders_Paged] @pagestart, @pagesize, @numresults OUTPUT", pagestartParam, pagesizeParam, numresultsParam, procResultParam);
            if (IsSqlParameterNull(numresultsParam))
                numresults = null;
            else
                numresults = (int) numresultsParam.Value;
    ...
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class FakeSampleDataContext : ISampleDataContext
    {
        ...
        public System.Data.Entity.DbSet<Intraday> Intradays { get; set; }
        ...
        public FakeSampleDataContext()
        {
            ...
            Intradays = new FakeDbSet<Intraday>("Id");
            ...
            MeetingAttendees = new FakeDbSet<MeetingAttendee>("MeetingId", "AttendeeId");
            ...
            Tasks = new FakeDbSet<Task>("TaskId");
            Territories = new FakeDbSet<Territory>("TerritoryId");
            Weathers = new FakeDbSet<Weather>("Id", "Station", "Date", "TMax", "TMin", "Wind", "Rain");
        }
    ...
    public class Intraday
    {
        ...
        public string Symbol { get; set; } // Symbol (length: 10)
    ...
    public class Meeting
    {
        ...
        public string RecurrenceRule { get; set; } // RecurrenceRule (length: 1073741823)
        public int? RecurrenceId { get; set; } // RecurrenceID
        public string RecurrenceException { get; set; } // RecurrenceException (length: 1073741823)
        public string StartTimezone { get; set; } // StartTimezone (length: 1073741823)
        public string EndTimezone { get; set; } // EndTimezone (length: 1073741823)

        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Meeting> Meetings { get; set; } // Meetings.FK_Meetings_Meetings
        public virtual System.Collections.Generic.ICollection<MeetingAttendee> MeetingAttendees { get; set; } // Many to many mapping

        // Foreign keys
        public virtual Meeting Recurrence { get; set; } // FK_Meetings_Meetings
    ...
    {
        public int MeetingId { get; set; } // MeetingID (Primary key)
        public int AttendeeId { get; set; } // AttendeeID (Primary key)

        // Foreign keys
        public virtual Meeting Meeting { get; set; } // FK_MeetingAtendee_Meeting
    }
    ...
    public class Task
    {
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<Task> Tasks { get; set; } // Tasks.FK_Tasks_Tasks

        // Foreign keys
        public virtual Task Recurrence { get; set; } // FK_Tasks_Tasks
    ...
    public class Weather
    {
        ...
        public string Station { get; set; } // Station (length: 255)
        public System.DateTime Date { get; set; } // Date
        public decimal TMax { get; set; } // TMax
        public decimal TMin { get; set; } // TMin
        public decimal Wind { get; set; } // Wind
        public decimal? Gust { get; set; } // Gust
        public decimal Rain { get; set; } // Rain
        public decimal? Snow { get; set; } // Snow
        public string Events { get; set; } // Events (length: 255)
    }
    ...
    public class CustomerConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Customer>
    {
        ...
        public CustomerConfiguration(string schema)
        {
            ...
            Property(x => x.Bool).HasColumnName(@"Bool").IsOptional().HasColumnType("bit");
    ...
    // Intraday
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class IntradayConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Intraday>
    {
        public IntradayConfiguration()
            : this("dbo")
        {
        }

        public IntradayConfiguration(string schema)
        {
            ToTable("Intraday", schema);
            HasKey(x => x.Id);

            Property(x => x.Id).HasColumnName(@"ID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.Symbol).HasColumnName(@"Symbol").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(10);
            Property(x => x.Date).HasColumnName(@"Date").IsRequired().HasColumnType("datetime");
            Property(x => x.Open).HasColumnName(@"Open").IsRequired().HasColumnType("decimal").HasPrecision(9,3);
            Property(x => x.High).HasColumnName(@"High").IsRequired().HasColumnType("decimal").HasPrecision(9,3);
            Property(x => x.Low).HasColumnName(@"Low").IsRequired().HasColumnType("decimal").HasPrecision(9,3);
            Property(x => x.Close).HasColumnName(@"Close").IsRequired().HasColumnType("decimal").HasPrecision(9,3);
            Property(x => x.Volume).HasColumnName(@"Volume").IsRequired().HasColumnType("bigint");
        }
    }
    ...
    // Meetings
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class MeetingConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Meeting>
    {
        ...
        public MeetingConfiguration(string schema)
        {
            ...
            Property(x => x.MeetingId).HasColumnName(@"MeetingID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.Start).HasColumnName(@"Start").IsRequired().HasColumnType("datetime");
            Property(x => x.End).HasColumnName(@"End").IsRequired().HasColumnType("datetime");
            Property(x => x.Title).HasColumnName(@"Title").IsRequired().HasColumnType("ntext").IsMaxLength();
            Property(x => x.Description).HasColumnName(@"Description").IsOptional().HasColumnType("ntext").IsMaxLength();
            Property(x => x.RoomId).HasColumnName(@"RoomID").IsOptional().HasColumnType("int");
            Property(x => x.IsAllDay).HasColumnName(@"IsAllDay").IsRequired().HasColumnType("bit");
            Property(x => x.RecurrenceRule).HasColumnName(@"RecurrenceRule").IsOptional().HasColumnType("ntext").IsMaxLength();
            Property(x => x.RecurrenceId).HasColumnName(@"RecurrenceID").IsOptional().HasColumnType("int");
            Property(x => x.RecurrenceException).HasColumnName(@"RecurrenceException").IsOptional().HasColumnType("ntext").IsMaxLength();
            Property(x => x.StartTimezone).HasColumnName(@"StartTimezone").IsOptional().HasColumnType("ntext").IsMaxLength();
            Property(x => x.EndTimezone).HasColumnName(@"EndTimezone").IsOptional().HasColumnType("ntext").IsMaxLength();

            // Foreign keys
            HasOptional(a => a.Recurrence).WithMany(b => b.Meetings).HasForeignKey(c => c.RecurrenceId).WillCascadeOnDelete(false); // FK_Meetings_Meetings
        }
    }

    // MeetingAttendees
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class MeetingAttendeeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<MeetingAttendee>
    {
        ...
        {
            ToTable("MeetingAttendees", schema);
            HasKey(x => new { x.MeetingId, x.AttendeeId });

            Property(x => x.MeetingId).HasColumnName(@"MeetingID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.AttendeeId).HasColumnName(@"AttendeeID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);

            // Foreign keys
            HasRequired(a => a.Meeting).WithMany(b => b.MeetingAttendees).HasForeignKey(c => c.MeetingId).WillCascadeOnDelete(false); // FK_MeetingAtendee_Meeting
        }
    }
    ...
    public class OrderConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Order>
    {
        ...
        public OrderConfiguration(string schema)
        {
            ...
            Property(x => x.Freight).HasColumnName(@"Freight").IsOptional().HasColumnType("decimal").HasPrecision(6,2);
            Property(x => x.ShipName).HasColumnName(@"ShipName").IsOptional().HasColumnType("nvarchar").HasMaxLength(40);
            Property(x => x.ShipAddress).HasColumnName(@"ShipAddress").IsOptional().HasColumnType("nvarchar").HasMaxLength(60);
            Property(x => x.ShipCity).HasColumnName(@"ShipCity").IsOptional().HasColumnType("nvarchar").HasMaxLength(15);
            Property(x => x.ShipRegion).HasColumnName(@"ShipRegion").IsOptional().HasColumnType("nvarchar").HasMaxLength(15);
    ...
    public class OrderDetailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<OrderDetail>
    {
        ...
        public OrderDetailConfiguration(string schema)
        {
            ...
            Property(x => x.UnitPrice).HasColumnName(@"UnitPrice").IsRequired().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Quantity).HasColumnName(@"Quantity").IsRequired().HasColumnType("smallint");
            Property(x => x.Discount).HasColumnName(@"Discount").IsRequired().HasColumnType("real");
    ...
    public class ProductConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Product>
    {
        ...
        public ProductConfiguration(string schema)
        {
            ...
            Property(x => x.CategoryId).HasColumnName(@"CategoryID").IsOptional().HasColumnType("int");
            Property(x => x.QuantityPerUnit).HasColumnName(@"QuantityPerUnit").IsOptional().HasColumnType("nvarchar").HasMaxLength(20);
            Property(x => x.UnitPrice).HasColumnName(@"UnitPrice").IsOptional().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.UnitsInStock).HasColumnName(@"UnitsInStock").IsOptional().HasColumnType("smallint");
            Property(x => x.UnitsOnOrder).HasColumnName(@"UnitsOnOrder").IsOptional().HasColumnType("smallint");
            Property(x => x.ReorderLevel).HasColumnName(@"ReorderLevel").IsOptional().HasColumnType("smallint");
            Property(x => x.Discontinued).HasColumnName(@"Discontinued").IsRequired().HasColumnType("bit");
    ...
    // Stock
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class StockConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Stock>
    {
    ...
    public class TaskConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Task>
    {
        ...
        public TaskConfiguration(string schema)
        {
            ...
            Property(x => x.TaskId).HasColumnName(@"TaskID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.Start).HasColumnName(@"Start").IsRequired().HasColumnType("datetime");
            Property(x => x.End).HasColumnName(@"End").IsRequired().HasColumnType("datetime");
            Property(x => x.Title).HasColumnName(@"Title").IsRequired().HasColumnType("ntext").IsMaxLength();
            Property(x => x.Description).HasColumnName(@"Description").IsOptional().HasColumnType("ntext").IsMaxLength();
            ...
            // Foreign keys
            HasOptional(a => a.Recurrence).WithMany(b => b.Tasks).HasForeignKey(c => c.RecurrenceId).WillCascadeOnDelete(false); // FK_Tasks_Tasks
        }
    }
    ...
    // Weather
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.24.0.0")]
    public class WeatherConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Weather>
    {
        ...
        public WeatherConfiguration(string schema)
        {
            ToTable("Weather", schema);
            HasKey(x => new { x.Id, x.Station, x.Date, x.TMax, x.TMin, x.Wind, x.Rain });

            Property(x => x.Id).HasColumnName(@"ID").IsRequired().HasColumnType("int").HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            Property(x => x.Station).HasColumnName(@"Station").IsRequired().IsUnicode(false).HasColumnType("varchar").HasMaxLength(255);
            Property(x => x.Date).HasColumnName(@"Date").IsRequired().HasColumnType("datetime");
            Property(x => x.TMax).HasColumnName(@"TMax").IsRequired().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.TMin).HasColumnName(@"TMin").IsRequired().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Wind).HasColumnName(@"Wind").IsRequired().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Gust).HasColumnName(@"Gust").IsOptional().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Rain).HasColumnName(@"Rain").IsRequired().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Snow).HasColumnName(@"Snow").IsOptional().HasColumnType("decimal").HasPrecision(5,2);
            Property(x => x.Events).HasColumnName(@"Events").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(255);
        }
    }
